package org.usfirst.frc.team449.robot.mechanism.activegearhandler;
...
public class ActiveGearHandler extends YamlSubsystem implements SubsystemSolenoid {
	 ...
	 */
	@JsonCreator
	public ActiveGearHandler(@NotNull @JsonProperty(required = true) MappedDoubleSolenoid piston) {
		this.piston = piston;
	}
