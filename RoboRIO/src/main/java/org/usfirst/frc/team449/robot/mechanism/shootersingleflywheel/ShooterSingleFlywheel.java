package org.usfirst.frc.team449.robot.mechanism.shootersingleflywheel;
...
public class ShooterSingleFlywheel extends YamlSubsystem implements Loggable, SubsystemShooter {
	 ...
	 */
	@JsonCreator
	public ShooterSingleFlywheel(@NotNull @JsonProperty(required = true) RotPerSecCANTalon shooterTalon,
