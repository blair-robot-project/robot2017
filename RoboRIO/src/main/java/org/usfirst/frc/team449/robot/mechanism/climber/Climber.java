...
public class Climber extends YamlSubsystem implements Loggable, SubsystemBinaryMotor, SubsystemConditional {
	 ...
	 */
	@JsonCreator
	public Climber(@NotNull @JsonProperty(required = true) RotPerSecCANTalon talonSRX,
