...
public class MappedUsbCamera extends UsbCamera{
	 ...
	 * @param width The width of this camera's output, in pixels. There's a minimum value for this that WPILib won't let
	 *                us go below, but I don't know what it is.
	 * @param height The height of this camera's output, in pixels. There's a minimum value for this that WPILib won't
	 *                  let us go below, but I don't know what it is.
	 * @param fps The frames per second this camera tries to transmit. There's a minimum value for this that WPILib
