...
public abstract class FactoryButton extends Button {
	 ...
	 *                       {@link TriggerButton}.
	 * @param triggerAt The amount, on [0, 1], that the joystick must be pushed to trigger. Must be null if triggerAxis
	 *                     is, and otherwise must have a value.
	 * @param angle The angle the D-pad needs to be pushed to to trigger this button. Must be null if either triggerAxis
